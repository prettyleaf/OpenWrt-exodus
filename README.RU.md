...
2. **Профили**: добавьте подписку или загрузите файл профиля. Заголовки HWID для панелей с лимитом устройств (Remnawave) отправляются по умолчанию, их значения видны на той же странице.
